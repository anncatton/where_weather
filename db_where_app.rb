...
# end_time = find_most_recent_time(station_id) + 3600
	...
	if station_id.nil?
		...
		query_observation = Observation.match_in_timeframe(station_id, '2016-01-25 18:00:00', '2016-01-26 16:00:00')
		...
		if query_observation.nil?
			...
			all_matches = query_observation.find_matches('2016-01-25 18:00:00', '2016-01-26 16:00:00')
